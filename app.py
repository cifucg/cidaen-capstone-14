...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Img(src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fhelp.twitch.tv%2Fs%2Farticle%2Ftwitch-chat-badges-guide%3Flanguage%3Den_US&psig=AOvVaw0pIOvdynXNArDKiUrIQo7A&ust=1622998271746000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCJiBw-35gPECFQAAAAAdAAAAABAD",
                     style={"width": "100px"}),
            html.H2(
                id='twitch-visit',
            )
